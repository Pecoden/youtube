...
function theme_woocommerce_mini_cart() {
    if (function_exists('woocommerce_mini_cart')) {
        ...
        ob_start(); ?>
        <a class="u-shopping-cart " data-payment-service="{&quot;id&quot;:&quot;8d409229275962e42396c83de742b67b&quot;,&quot;formServices&quot;:[],&quot;paymentMethods&quot;:[],&quot;userToken&quot;:&quot;1177ff2d-42f7-4e6c-830a-52ae4ffc0695&quot;}" href="#popup-4eb6">
...
function getProductButtonHtml ($button_html, $product, $clickTypeProductbutton = 'add-to-cart', $contentProductbutton = '') {
    ...
    $buttonText = sprintf(__('Add to cart', 'site3'));
    if ($contentProductbutton !== '') {
        $buttonText =  sprintf(__($contentProductbutton, 'site3'));
    }
...
function theme_404_content($args = '') {
    $args = wp_parse_args($args, array(
        'error_title' => __('Nothing here', 'site3'),
        'error_message' => __('It looks like nothing was found at this location. Maybe try a search?', 'site3')
    ));
    extract($args);
