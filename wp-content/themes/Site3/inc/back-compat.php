...
function theme_compat_upgrade_notice() {
    $message = sprintf(__('This theme requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'site3'), $GLOBALS['wp_version']);
...
function theme_compat_customize() {
    wp_die(sprintf(__('This theme requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'site3'), $GLOBALS['wp_version']), '', array(
        'back_link' => true,
    ));
}
...
function theme_compat_preview() {
    if (isset($_GET['preview'])) {
        wp_die(sprintf(__('This theme requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'site3'), $GLOBALS['wp_version']));
    }
}
